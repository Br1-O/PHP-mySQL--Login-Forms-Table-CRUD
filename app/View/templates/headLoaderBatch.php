...
<html lang="en">
    ...
    <body>
        ...
        <!-- ■■■■■■■■ NavBar ■■■■■■■■-->  
            ...
            <nav class="navbar navbar-expand-md navbar-light navbar-container1 position-sticky">
                ...
                <div class="collapse navbar-collapse nav-list1 navbar1" id="navbar-toggler">
                    ...
                    <li class="nav-item1">
                        <a href="#" id='login-link' title="¡Ingrese a su cuenta para un mejor servicio!" data-bs-target="#LoginToggle" data-bs-toggle="modal"> Ingresar </a>
                    </li>
                    </ul>
                    ...
                    <div class="modal-content">
                        <div class='loginBody'>
                            ...
                            <div class="modal-header">
                                <h1 class="loginTitle fs-5 mb-0" id="LoginToggleLabel"> Ingrese a su cuenta </h1>
                                    ...
                                    <div class='row'> 
                                        ...
                                        <div class='col-6 d-flex align-items-center justify-content-center p-1 formLogin'>
                                            <div class='w-75 login'>
                                                ...
                                                <input type="text" class="form-control" name="user_login" id='user_login' placeholder="Ingrese su Usuario" required>
                            ...
                            <div class="modal-footer modalFooter">
                                <a href='#' data-bs-target="#LoginToggle2" data-bs-toggle="modal"> ¿No tiene cuenta? ¡Cree su cuenta aquí!</a>
                            </div>
                        </div>
        ...
        <!-- Modal · Register -->
            ...
            <div class="modal fade" id="LoginToggle2" aria-hidden="true" aria-labelledby="LoginToggleLabel2" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content loginBody">
                        <div class='loginBody'>    
                            <div class="modal-header">
                            ...
                            <div class="modal-footer modalFooter">
                                <a id='toggleLogin2' href='#' data-bs-target="#LoginToggle" data-bs-toggle="modal"> ¿Ya posee una cuenta? Ingrese aquí</a>
                            </div>
                        </div>
                    </div>
                </div>
